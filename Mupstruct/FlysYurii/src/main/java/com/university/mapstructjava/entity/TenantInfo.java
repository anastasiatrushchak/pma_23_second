...
public class TenantInfo {
    ...
    public TenantInfo(String tenantName, String tenantEmail, String tenantPhone, String tenantOccupation, Long tenantAge, Long tenantCreditScore, String agreementDate, String agreementStartDate, String agreementEndDate, String agreementType, String additionalTerms) {
    ...
    public String toString() {
        return "TenantInfo{" +
                ...
                ", tentantEmail='" + tenantEmail + '\'' +
                ", tentantPhone='" + tenantPhone + '\'' +
                ", tentantOccupation='" + tenantOccupation + '\'' +
                ", tentantAge=" + tenantAge +
                ", tentantCreditScore=" + tenantCreditScore +
