    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (method == "border")
            {
                ...
                try
                {
                    StreamReader st = new StreamReader("C:\\Users\\Златомира\\source\\repos\\C#\\ZS-01\\FibonachiBorder\\InputBorder.txt");
            ...
            else if (method == "steps")
            {
                ...
                try
                {
                    StreamReader st = new StreamReader("C:\\Users\\Златомира\\source\\repos\\C#\\ZS-01\\FibonachiBorder\\InputSteps.txt");
                    line = st.ReadLine().Split(" ");
